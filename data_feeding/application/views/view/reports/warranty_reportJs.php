...
jQuery(document).ready(function(){
    ...
    $("#submitTrain").click(function(){
        ...
        var url="<?php echo base_url().'/view/CreateForm/filterWarrantyReport/1690450752274'; ?>";
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("body").on("click","button.status_action",function(){
            ...
            var req_id = $(this).val();
            var family_id = $(this).attr("data-status");
            console.log(req_id);
            console.log(family_id);

            swal({
                title: "Are you sure?",
                text: "You want to send the data.",
                type: "info",
                showCancelButton: true,
                closeOnConfirm: false,
                showLoaderOnConfirm: true,
            }, function () {
                $.post("<?php echo base_url("view/CreateForm/sendItemForRating"); ?>",{
                    req_id:req_id,
                    family_id:family_id
                },function(data){
                    if(data=="200"){
                        swal("Data Send .");
                        location.reload();
                        //btndiv.html("<span class='font-bold col-teal'>Send</span>");
                    }else{
