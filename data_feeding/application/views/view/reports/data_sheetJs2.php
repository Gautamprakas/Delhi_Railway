                            ...
                            // if(data[family_id].hasOwnProperty(value)){
                                if(value=="1690365766_2"){
                                    ...
                                    if(workList.length>1){
                                        ...
                                        if(work.length>1){
                                            $("#tableID"+j+"_5").text(work[1]);
                                        }else{
                                            $("#tableID"+j+"_5").text(workList[0]);
                                        }
                                    }else{
                                        $("#tableID"+j+"_5").text("");
                                    }
                                ...
                                if(!(data[family_id].hasOwnProperty("1690365766B_2"))){
                                    if (value="item_list") {
                                        $("#tableID"+j+"_7").html(data[family_id][value]);
                                    }

                                }
                                if(value=="1690365766B_2"){
                                    $("#tableID"+j+"_7").text(data[family_id][value]);
                                }
                                if(value=="Rating Status"){
                                    $("#tableID"+j+"_11").html(data[family_id][value]);
                                }1690450752274_2
                                if(value=="1690450752274_2"){
