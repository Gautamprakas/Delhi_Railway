...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#submitTrain").click(function(event){

            event.preventDefault();
            var trainNo=$("#trainInput").val();
            $.ajax({

                url:'<?php echo base_url("view/CreateForm/saveAddTrain"); ?>',
                method:'POST',
                data:{
                    trainNo:trainNo,
                },
                success:function(response){
                    alert(response);
                    window.location.href='<?php echo base_url("view/CreateForm/addTrain"); ?>';
