...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#submitWarrantyDays").click(function(event){

            event.preventDefault();
            var days=$("#daysInput").val();
            $.ajax({

                url:'<?php echo base_url("view/CreateForm/saveaddWarranty"); ?>',
                method:'POST',
                data:{
                    days:days,
                },
                success:function(response){
                    alert(response);
                    window.location.href='<?php echo base_url("view/CreateForm/addWarranty"); ?>';
