    ...
    <script type="text/javascript">
        function submitData(){
                ...
                for (var i = 1; i <= len; i++) {
                    ...
                    if (selectValue){
                        item=selectValueTag.data('properties');
                        status=selectValue;
                        console.log(item);
                        console.log(status);
                    }
                ...
                $.ajax({
                    url:'<?php echo base_url("view/CreateForm/saveUpdateItem"); ?>',
                    method:'POST',
                    data:{
                        item:item,
                        status:status,
                    ...
                    success:function(response){
                        alert(response);
                        window.location.href='<?php echo base_url("view/CreateForm/editItem"); ?>';
                    },
