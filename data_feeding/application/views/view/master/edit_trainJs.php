    ...
    <script type="text/javascript">
        function submitData(){
                ...
                for (var i = 1; i <= len; i++) {
                    ...
                    if (selectValue){
                        trainNo=selectValueTag.data('properties');
                        status=selectValue;
                        console.log(trainNo);
                        console.log(status);
                    }
                ...
                $.ajax({
                    url:'<?php echo base_url("view/CreateForm/saveUpdateTrain"); ?>',
                    method:'POST',
                    data:{
                        trainNo:trainNo,
                        status:status,
                    ...
                    success:function(response){
                        alert(response);
                        window.location.href='<?php echo base_url("view/CreateForm/editTrain"); ?>';
                    },
