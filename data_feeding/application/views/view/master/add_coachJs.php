...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#submitCoach").click(function(event){

            event.preventDefault();
            var CoachNo=$("#coachNumber").val();
            var CoachCat=$("#coachCategory").val();
            // console.log(CoachNo+CoachCat);
            $.ajax({

                url:'<?php echo base_url("view/CreateForm/saveCoach"); ?>',
                method:'POST',
                data:{
                    CoachNo:CoachNo,
                    CoachCat:CoachCat,
                ...
                success:function(response){
                    alert(response);
                    window.location.href='<?php echo base_url("view/CreateForm/addCoach"); ?>';
