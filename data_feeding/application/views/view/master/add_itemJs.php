...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#submitItem").click(function(event){
            ...
            var uom_value=$("#uom_value").val();
            // console.log(itemName+uom_value);
            $.ajax({

                url:'<?php echo base_url("view/CreateForm/saveItem"); ?>',
                method:'POST',
                data:{
                    itemName:itemName,
                    uom_value:uom_value,
                ...
                success:function(response){
                    alert(response);
                    window.location.href='<?php echo base_url("view/CreateForm/addItem"); ?>';
