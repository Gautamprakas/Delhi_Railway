...
<!--                     <div class="input-group">
                   ...
                   <div class="input-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <a href="<?php echo base_url("survey_controller/unset_all"); ?>" class="btn btn-block bg-red waves-effect" onclick="window.close();">Close</a>
...
<script>
    $("form").on("submit", function (e) {
        ...
        var json = JSON.parse('<?php echo json_encode($json); ?>');
        //console.log(json);
        reqdata = '';
...
/*        $.each($('.fileupload'),function(index,ans_field){
        ...
        $.get("<?php echo base_url("Survey_controller/current_datetime"); ?>",function(datetime){
            $.post("<?php echo base_url("api/updateFormData"); ?>",{
